...
/**
 * Created by jacklian on 24/03/2016.
 */
public class UpgradeListing extends Group {
    ...
    public UpgradeListing(Integer row, final Runnable block) {
        level = 1;
        this.row = row;
        this.baseCost = 5;
        ...
        Label desLabel = new Label("Upgrade", uiSkin);
